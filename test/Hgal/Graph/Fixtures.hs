...
data HalfedgeFixture g = HalfedgeFixture
  { halfedgeFixture :: g
  , h1, h2, h3 :: H g
  }
...
surfaceFixture1 :: SurfaceFixtureC a g
                => IO (FaceFixture g)
surfaceFixture1 = do
...
surfaceFixture4 :: SurfaceFixtureC a g
                => IO (HalfedgeFixture g)
surfaceFixture4 = do
...
surfaceFixture5 :: SurfaceFixtureC a g
                => IO (HalfedgeFixture g)
surfaceFixture5 = do
...
surfaceFixture6 :: SurfaceFixtureC a g
                => IO (HalfedgeFixture g)
surfaceFixture6 = do
...
surfaceFixture7 :: SurfaceFixtureC a g
                => IO (HalfedgeFixture g)
surfaceFixture7 = do
...
surfaceFixture8 :: SurfaceFixtureC a g
                => IO (HalfedgeFixture g)
surfaceFixture8 = do
